...
export const products = [
  {
    ...
    heart_notes: ['Oud', 'Rose', 'Amber'],
    base_notes: ['Sandalwood', 'Musk', 'Vetiver'],
    is_featured: true,
  },
  {
    id: '2',
    ...
    heart_notes: ['Jasmine', 'White Rose', 'Ylang-Ylang'],
    base_notes: ['Musk', 'Cedarwood', 'Ambrette'],
    is_featured: true,
  },
  {
    id: '3',
    ...
    category: 'Woody',
    top_notes: ['Pine', 'Galbanum', 'Cold Air'],
    heart_notes: ['Cedarwood', 'Iris', 'Violet'],
    base_notes: ['Patchouli', 'Leather', 'Oakmoss'],
    is_featured: true,
  },
  // {
  //   id: '4',
